...
Subnet Mask
(255.255.255.0, 255.255.255.128, etc.)
```
...
Convert `255.255.255.128` into CIDR.
...
3. Line them up and do AND, bit by bit.
4. Whatever comes out = the Network ID.
